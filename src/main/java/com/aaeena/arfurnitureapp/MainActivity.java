package com.aaeena.arfurnitureapp;
...
//        fragment.getArSceneView().getScene().setOnUpdateListener(this::onUpdateFrame);
    ...
    private void onResolveOKPressed(String dialogValue) {
        ...
        storageManager.getCloudAnchorID(shortCode, (cloudAnchorId) -> {
            ...
            Log.d("Nokhaiz", "onResolveAnchor: " + resolvedAnchor);
            ...
            if (cloudState.isError()) {
                ...
                storageManager.nextShortCode((shortCode) -> {
                    ...
                    snackbarHelper.showMessageWithDismiss(this, "Anchor hosted! Cloud Short Code: "
                            + shortCode);
                    Log.d("Nokhaiz", "checkUpdatedAnchor code: " + shortCode);
                });
    ...
    private void InitializeGallery() {
        ...
        goat.setOnClickListener(view -> {
            selectedObject = Uri.parse("goat.sfb");
        });
        ...
        sofa.setOnClickListener(view -> {
            selectedObject = Uri.parse("sofa.sfb");
        });
    ...
    private void placeObject(ArFragment fragment, Anchor anchor, Uri model) {
        Log.d("Nokhaiz", "placeObject Anchor: " + anchor);
        Log.d("Nokhaiz", "placeObject Model: " + model);
